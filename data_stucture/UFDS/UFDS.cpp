...
public:
    vi rank,Setsize;
    vii parent;///parent and length to parent
    int n;
    ...
    UFDS(int _n){
        ...
        Setsize.assign(n,1);
        parent.resize(n);
        for(int i=0;i<n; i++) parent[i]=mp(i,0);
    }
    ...
    void union_set(int u,int v){
        ...
        int pu=findset(u).ff,pv=findset(v).ff;
...
int main()
{
    ...
    while(n--){
        int u,v; cin>>u>>v;
        ufds.union_set(u,v);
        cout<<ufds.parent[u]<<endl;
        cout<<ufds.parent[v]<<endl;
        cout<<ufds.Setsize[u]<<endl;
    }
