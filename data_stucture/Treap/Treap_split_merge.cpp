...
int main()
{
    ...
    insert(root,new item(4,rand()%20));
    insert(root,new item(5,rand()%20));
    insert(root,new item(2,rand()%20));
    insert(root,new item(1,rand()%20));
    insert(root,new item(3,rand()%20));

    inorder(root);

    insert(root,new item(6,rand()%20));
    insert(root,new item(7,rand()%20));
    inorder(root);
